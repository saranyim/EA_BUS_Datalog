...
*/
  ...
  */
  ...
  /*
    CMSIS-RTOS2 function vTaskDelay uses FreeRTOS function vTaskDelay. In case if
    vTaskDelay is not used in the application image, compiler will optimize it away.
  ...
  */
  ...
  /*
    CMSIS-RTOS2 function vTaskDelayUntil uses FreeRTOS function xTaskDelayUntil. In case if
    vTaskDelayUntil is not used in the application image, compiler will optimize it away.
